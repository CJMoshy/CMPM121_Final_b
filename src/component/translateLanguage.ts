...
export const translationObject: TranslateObject = {
    ...
    cn: {
        ...
        "None": "无",
        "Game is automatically saved after every turn, but you can manually save at any point": "游戏会在每回合后自动保存，但您可以随时手动保存",
        "Loading": "加载中",
        "1": "1",
        "2": "2",
        "3": "3",
    ...
    fa: {
        ...
        "None": "هیچکدام",
        "Game is automatically saved after every turn, but you can manually save at any point": "بازی به طور خودکار بعد از هر نوبت ذخیره می‌شود، اما می‌توانید هر لحظه به صورت دستی ذخیره کنید",
